...
// Generics, varargs & boxing working together:
        ...
        System.out.print(result);
        System.out.print(filter(li, new GreaterThan<Integer>(4)));
        System.out.print(forEach(li,
                new MultiplyingIntegerCollector()).result());
        System.out.print(forEach(filter(li, new GreaterThan<Integer>(4)),
                new MultiplyingIntegerCollector()).result());
        ...
        System.out.print(rbd);
        System.out.print(filter(lbd,
...
// Use the prime-generation facility of BigInteger:
        ...
        System.out.print(lbi);
        BigInteger rbi = reduce(lbi, new BigIntegerAdder());
        System.out.print(rbi);
// The sum of this list of primes is also prime:
        System.out.print(rbi.isProbablePrime(5));
        List<AtomicLong> lal = Arrays.asList(
                new AtomicLong(11), new AtomicLong(47),
                new AtomicLong(74), new AtomicLong(133));
        AtomicLong ral = reduce(lal, new AtomicLongAdder());
        System.out.print(ral);
        System.out.print(transform(lbd,new BigDecimalUlp()));
    }
}